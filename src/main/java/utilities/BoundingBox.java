...
public class BoundingBox {
	...
	/**
	* This method checks collision between this object and solely right side of other object. 
	* @param other : Other bound.
	* @return True if intersects right.
	*/

	public boolean intersectsRight(BoundingBox other) {
		if(left < other.getRight() && getRight() > other.getRight() && left > other.getLeft() + other.getWidth() - 5) {
			return true;
		}
		return false;
	}
